...
.controller('HomeCtrl', function($scope, $ionicLoading, $ionicPopup) {
  $scope.choices = {choice: ""};

  $scope.showAlert = function() {
    var alertPopup = $ionicPopup.alert({
      title: 'Submitted',
      template: 'Thank you you answer has been submitted'
    });

    alertPopup.then(function(res) {
      console.log('Thank you you answer has been submitted');
    });
  };

  $scope.$watch('choices.choice', function(value) {
